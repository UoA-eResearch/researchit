...
$conf['rest_url'] = 'bogus';
$conf['rest_credentials'] = base64_encode('bogus:bogus');
$conf['ldap_credentials'] = "-H ldaps://bogus -D bogus -w 'bogus' -b 'dc=bogus,dc=bogus,dc=bogus,dc=bogus";
$conf['symplectic_server'] = 'bogus';
$conf['symplectic_username'] = 'bogus';
$conf['symplectic_password'] = 'bogus';